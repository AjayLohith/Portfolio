...
const Footer = () => {
  ...
  return (
    <footer className="py-8 px-6 text-center text-portfolio-textSecondary">
      <div className="flex justify-center space-x-5 mb-4">
        <a 
          ...
          aria-label="GitHub"
          className="text-portfolio-textSecondary hover:text-portfolio-green transition-colors"
        >
