  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-16 pb-0 px-6">
      <div className="max-w-5xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        {/* Right Side: Photo Placeholder                                                     photo resizer here(xl:w-[480]) */}
        <div className="relative group mx-auto w-full sm:w-[200px] md:w-[500px] lg:w-[600px] xl:w-[480px] h-auto">
          {/* Outer Border */}
